...
<div class="archive-nav-bar">
  <a href="{{ '/' | relative_url }}" class="archive-back-link">← 返回博客首页</a>
  <span class="archive-badge">🌌 2026 七夕专属浪漫限定 · 永久归档</span>
</div>
...
<div class="archive-bottom-cta">
  <p>愿每一份深情都不被辜负，愿岁岁年年皆有星光相伴。</p>
  <a href="{{ '/' | relative_url }}" class="btn btn-back-home">返回技术博客主站 →</a>
</div>
